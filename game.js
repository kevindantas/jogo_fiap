var game = new Phaser.Game(800,600, Phaser.AUTO, 'tetris-revenge', {preload: preload, create: create, update: update, render: render});
...
function preload() {
    ...
    game.load.image('ship', 'assets/player2.png');
    game.load.image('bullet', 'assets/bullet2.png');
    game.load.image('enemy-green', 'assets/enemy-green2.png');
    game.load.image('blueEnemyBullet', 'assets/enemy-blue-bullet.png');
    game.load.image('enemy-blue', 'assets/enemy-blue2.png');
    ...
    game.load.audio('mfundo', ['assets/sounds/bg-tetris.mp3']);
    //game.load.audio('somExplosao', ['assets/sounds/Explosion1.wav']);
    //game.load.audio('somTiro', ['assets/sounds/tiro1.wav']);
...
function create() {
    ...
    //Music background
    musicaFundo = game.add.audio('mfundo');

    musicaFundo.play('', 0,0.1, true);

    //Fullscreen mode
    key1 = game.input.keyboard.addKey(Phaser.Keyboard.ONE);
    key1.onDown.add(go_fullscreen, this);
    ...
    // Player shoot sound
    //som_tiro = game.add.audio('somTiro');

    // Explosion sound
    som_explosao = game.add.audio('somExplosao');
...
function render() {
    ...
    /*
    //Pra debugar o hitbox do inimigo é só ativar isso
